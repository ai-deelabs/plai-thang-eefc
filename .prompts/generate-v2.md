...
Full-bleed dark hero, single centered column, hairline rule dividers, minimal nav — Geometric monospace display headlines with thin humanist sans body and terminal-cursor accents — Dark mode referencing Bangkok night-market neon after midnight: charcoal canvas #12181A + single electric jade accent #00E5A0, hairline mist blue #3A4A4D — Nocturnal, electric, adventurous energy
