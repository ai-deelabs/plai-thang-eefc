...
Diagonal-cut poster sections with a grid of chunky rounded photo cards and color-blocked banners — Chunky rounded slab display type in bold all-caps poster lettering — Bold duotone referencing vintage Thai enamelware (khan tok blue-and-white ceramics): enamel cobalt #0B6E8C dominant + bone white #F7F4EC neutral, stark high contrast — Punchy, playful, high-contrast pop energy
